...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen selection:bg-zinc-200 bg-white">
      ...
      <section id="foundations-section" className="relative w-full py-24 px-6 sm:px-12 lg:px-20 bg-[#faf8f5] text-zinc-900 border-b border-[#eee9df]">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={0}>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-zinc-200/90 border border-zinc-300 text-zinc-800 font-mono text-xs font-semibold mb-4 shadow-xs">
      ...
      {/* 4. ENCRYPTED TIME-WEIGHTED AVERAGE BALANCE (TWAB) SECTION (WHITE) */}
      <section id="twab-section" className="relative w-full py-24 px-6 sm:px-12 lg:px-20 bg-white text-zinc-900 border-b border-zinc-200">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={0}>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-zinc-100 border border-zinc-200 text-zinc-800 font-mono text-xs font-semibold mb-4 shadow-xs">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-6 space-y-5">
              ...
              <ScrollReveal delay={80}>
                <div className="p-6 sm:p-7 rounded-3xl bg-zinc-50 border border-zinc-200/80 space-y-3 shadow-xs hover-elevate">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-zinc-500 uppercase">Flawed Conventional DeFi</span>
                    <span className="text-xs font-mono text-rose-600 bg-rose-50 px-3 py-1 rounded-full border border-rose-200">Snapshots</span>
                  </div>
              ...
              <ScrollReveal delay={160}>
                <div className="p-6 sm:p-7 rounded-3xl bg-zinc-950 border border-zinc-800 text-white space-y-3 shadow-xs hover-elevate">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono font-bold text-emerald-400 uppercase">Ghost Cryptographic TWAB</span>
                    <span className="text-xs font-mono text-emerald-400 bg-emerald-950/70 px-3 py-1 rounded-full border border-emerald-800">Continuous Integration</span>
                  </div>
            ...
            <div className="lg:col-span-6">
              <ScrollReveal delay={120} className="h-full">
                <div className="h-full flex flex-col justify-between p-6 sm:p-8 rounded-3xl bg-white border border-zinc-200/90 shadow-xs hover-elevate">
                  ...
                  <div className="pt-6 mt-6 border-t border-zinc-100 flex items-center justify-between text-xs font-mono text-zinc-500">
                    <span className="px-3 py-1 rounded-full bg-zinc-100 border border-zinc-200">Standard: Zama euint64</span>
                    <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 font-semibold">Zero-Knowledge Odds</span>
                  </div>
                </div>
              </ScrollReveal>
            </div>
      ...
      {/* 5. AUTONOMOUS $500 PRIZE KEEPER & ROLLOVER ENGINE (DARK - bg-zinc-950) */}
      <section id="keeper-section" className="relative w-full py-24 px-6 sm:px-12 lg:px-20 bg-zinc-950 text-white border-b border-zinc-900">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal delay={0}>
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-zinc-900 border border-zinc-800 text-amber-400 font-mono text-xs font-semibold mb-4 shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <ScrollReveal delay={60}>
              <div className="p-7 rounded-3xl bg-zinc-900/90 border border-zinc-800 flex flex-col justify-between h-full hover:border-zinc-700 transition-colors shadow-xs">
                <div>
                  <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-amber-400 mb-5">
                ...
                <div className="pt-4 border-t border-zinc-800 text-[10px] text-zinc-500 font-mono flex items-center justify-between">
                  <span>Threshold</span>
                  <span className="px-2.5 py-0.5 rounded-full bg-zinc-800 text-amber-300 border border-zinc-700">500 cUSDC</span>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={140}>
              <div className="p-7 rounded-3xl bg-zinc-900/90 border border-zinc-800 flex flex-col justify-between h-full hover:border-zinc-700 transition-colors shadow-xs">
                <div>
                  <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-emerald-400 mb-5">
                ...
                <div className="pt-4 border-t border-zinc-800 text-[10px] text-zinc-500 font-mono flex items-center justify-between">
                  <span>Rollover</span>
                  <span className="px-2.5 py-0.5 rounded-full bg-zinc-800 text-emerald-300 border border-zinc-700">Cycle + 1</span>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={220}>
              <div className="p-7 rounded-3xl bg-zinc-900/90 border border-zinc-800 flex flex-col justify-between h-full hover:border-zinc-700 transition-colors shadow-xs">
                <div>
                  <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-300 mb-5">
                ...
                <div className="pt-4 border-t border-zinc-800 text-[10px] text-zinc-500 font-mono flex items-center justify-between">
                  ...
                  <span className="px-2.5 py-0.5 rounded-full bg-zinc-800 text-zinc-300 border border-zinc-700">Torus FHE</span>
                </div>
              </div>
            </ScrollReveal>
          ...
          <ScrollReveal delay={180}>
            <div className="mt-12 p-6 sm:p-7 rounded-3xl bg-zinc-900/60 border border-zinc-800/80 shadow-xs">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3 font-mono text-xs">
                  <span className="px-4 py-1.5 rounded-full bg-zinc-800 border border-zinc-700 text-emerald-400">Yield ≥ $500 → Execute Draw</span>
                  <span className="px-4 py-1.5 rounded-full bg-zinc-800 border border-zinc-700 text-amber-400">Yield &lt; $500 → Rollover 24h</span>
                </div>
              </div>
            </div>
          </ScrollReveal>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <ScrollReveal delay={50}>
              <div className="p-7 rounded-3xl bg-zinc-900 border border-zinc-800 flex flex-col justify-between h-full hover:border-zinc-700 transition-colors shadow-xs">
                <div>
          ...
          <ScrollReveal delay={180}>
            <div className="mt-14 p-6 sm:p-7 rounded-3xl bg-zinc-950 border border-zinc-800/80 text-xs font-mono grid grid-cols-2 sm:grid-cols-4 gap-4 shadow-xs">
              <div>
      ...
      {/* 7. CRYPTOGRAPHIC CLEARANCE & CLIENT-SIDE UNMASKING (CREAM SECTION - bg-[#faf8f5]) */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <ScrollReveal delay={80}>
                <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#eae2d5] shadow-xs space-y-3 hover-elevate">
            ...
            {/* Right Column: Interactive Clearance Simulation Card */}
            <div className="lg:col-span-5">
              <ScrollReveal delay={120}>
                <div className="p-7 sm:p-8 rounded-3xl bg-white border border-[#eae2d5] shadow-sm space-y-5 hover-elevate">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-mono text-zinc-500 uppercase">Live Decryption Demo</span>
                    <span className={`text-[11px] font-mono font-semibold px-3 py-1 rounded-full border ${demoDecrypted ? 'text-emerald-700 bg-emerald-50 border-emerald-200' : 'text-zinc-600 bg-zinc-100 border-zinc-200'}`}>
                  ...
                  <button
                    ...
                    className="w-full py-3 px-5 rounded-full text-xs font-semibold font-mono bg-zinc-900 text-white hover:bg-black transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm hover:scale-102"
                  >
                    {demoDecrypted ? (
                      <>
      ...
      <section id="security-section" className="relative w-full py-24 px-6 sm:px-12 lg:px-20 bg-[#faf8f5] text-zinc-900 border-b border-[#eee9df]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ScrollReveal delay={80}>
              <div className="p-8 rounded-3xl bg-white border border-[#eae2d5] shadow-xs hover-elevate">
        ...
        <div className="relative max-w-2xl mx-auto z-10">
          ...
          <ScrollReveal delay={240}>
            <button
              ...
              className="btn-pill-white px-8 py-3.5 text-sm font-semibold inline-flex items-center gap-2 shadow-xl hover:scale-102 transition-transform cursor-pointer"
            >
