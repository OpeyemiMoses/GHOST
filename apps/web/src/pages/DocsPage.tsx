  ...
  return (
    <div className="w-full h-full min-h-[calc(100vh-16px)] sm:min-h-[calc(100vh-24px)] flex flex-col bg-white text-zinc-900 overflow-hidden">
      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
        ...
        {/* RIGHT PANEL: Scrollable Content Viewport (Everything scrolls independently here) */}
        <main id="docs-content-viewport" className="flex-1 min-w-0 h-full overflow-y-auto p-6 sm:p-10 bg-white space-y-8 selection:bg-zinc-200">
