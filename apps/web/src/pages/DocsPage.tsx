...
export const DocsPage: React.FC = () => {
  ...
  const docAreas: DocArea[] = [
    ...
    },
    {
      ...
      icon: Cpu,
      subpages: [
        { id: 'protocol-overview', title: 'Protocol Overview', description: 'System layers and contract hierarchy' },
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 text-xs text-zinc-600 leading-relaxed">
                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3">
                        <h3 className="font-bold text-xs text-zinc-900">1. Network & Wallet Requirements</h3>
                        <p>
                      ...
                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3">
                        <h3 className="font-bold text-xs text-zinc-900">2. Connecting & Session Authorization</h3>
                        <p>
                      ...
                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3">
                        <h3 className="font-bold text-xs text-zinc-900">3. Minting Testnet cUSDC & Depositing</h3>
                        <p>
                      ...
                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3">
                        <h3 className="font-bold text-xs text-zinc-900">4. Decrypting & Re-Sealing Your Position</h3>
                        <p>
                ...
                {activeSubPageId === 'why-ghost' && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-1">
                        Addressing the fundamental blockchain privacy problem.
                      </p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="p-5 rounded-2xl bg-zinc-50 border border-red-200/60 space-y-3">
                        <div className="text-[10px] font-mono uppercase font-bold text-red-600">Traditional Transparent Blockchain</div>
                        <div className="p-3.5 bg-white rounded-xl border border-zinc-200 font-mono text-xs text-zinc-700 leading-relaxed">
                          Wallet Address<br />
                          &nbsp;&nbsp;↓ (Plaintext Deposit)<br />
                          Public Blockchain Node<br />
                          &nbsp;&nbsp;↓ (Plaintext Event Emission)<br />
                          <span className="text-red-600 font-bold">Public Balances & Holdings</span><br />
                          <span className="text-red-600 font-bold">Public Odds & Winning Tickets</span><br />
                          <span className="text-red-600 font-bold">Public MEV Surveillance</span>
                        </div>
                        <p className="text-xs text-zinc-600">
                          Every participant's balance is readable by bots, exposing savers to front-running, copy-trading, and targeted attacks.
                        </p>
                      </div>

                      <div className="p-5 rounded-2xl bg-zinc-50 border border-emerald-200/60 space-y-3">
                        <div className="text-[10px] font-mono uppercase font-bold text-emerald-600">Ghost Confidential Protocol</div>
                        <div className="p-3.5 bg-white rounded-xl border border-zinc-200 font-mono text-xs text-zinc-700 leading-relaxed">
                          Wallet Address<br />
                          &nbsp;&nbsp;↓ (Client-Side Encryption)<br />
                          Ghost Protocol Contracts<br />
                          &nbsp;&nbsp;↓ (euint64 Ciphertext Handles)<br />
                          <span className="text-emerald-700 font-bold">Encrypted Financial State</span><br />
                          <span className="text-emerald-700 font-bold">Homomorphic FHE Computation</span><br />
                          <span className="text-emerald-700 font-bold">Verifiable State Roots & Proofs</span>
                        </div>
                        <p className="text-xs text-zinc-600">
                          Zama's encrypted-input model submits values as ciphertexts with cryptographic proofs, computing over encrypted state securely.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {activeSubPageId === 'how-ghost-works' && (
                  <div className="space-y-6">
                    ...
                    {/* 7-Step Flagship Journey Cards */}
                    <div className="space-y-3">
                      {[
                        { step: '01', title: 'You Deposit', desc: 'Your wallet initiates a non-custodial transaction with your testnet cUSDC tokens.' },
                        { step: '02', title: 'Sensitive Input is Encrypted', desc: 'The token quantity is encrypted client-side into an euint64 ciphertext handle with cryptographic proof.' },
                        { step: '03', title: 'Ghost Stores Encrypted State', desc: 'Ghost contracts update balance mappings using 32-byte ciphertext pointers without exposing plaintext numbers.' },
                        { step: '04', title: 'Ghost Computes Privately', desc: 'Torus FHE coprocessor computes yield additions and lottery odds directly over encrypted integers.' },
                        { step: '05', title: 'The Protocol Produces a Result', desc: 'Ghost outputs a confidential state transition and prize allocation without leaking participant stakes.' },
                        { step: '06', title: 'The Result is Verifiable', desc: 'Merkle state roots and randomness commitments are published onchain for independent public audit.' },
                        { step: '07', title: 'You Access Your Information', desc: 'You authorize client-side decryption using an ephemeral wallet signature to view your unmasked balance.' },
                      ].map((s) => (
                        <div key={s.step} className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200/80 flex items-start gap-3.5">
                          <span className="w-8 h-8 rounded-full bg-zinc-900 text-white font-mono text-xs font-bold flex items-center justify-center shrink-0">
                            {s.step}
                          </span>
                          <div>
                            <h3 className="font-bold text-xs text-zinc-900">{s.title}</h3>
              ...
              <div className="space-y-8">
                    ...
                    <div className="space-y-4 text-xs text-zinc-600 leading-relaxed">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                        <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200">
                          <h3 className="font-bold text-xs text-zinc-900 mb-1">Target Environment</h3>
                          <p className="text-xs text-zinc-600">Ethereum Sepolia Testnet with Zama fhEVM coprocessor infrastructure.</p>
                        </div>
                        <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200">
                          <h3 className="font-bold text-xs text-zinc-900 mb-1">Underlying Asset</h3>
                ...
                {activeSubPageId === 'deposits' && (
                  <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 font-mono text-xs text-zinc-700 leading-relaxed">
                      Connect Wallet (MetaMask / Rainbow)<br />
                      &nbsp;&nbsp;↓ Choose Asset (cUSDC)<br />
                      Enter Deposit Amount (e.g. 500.00)<br />
                      &nbsp;&nbsp;↓ Encrypt Input into euint64 ciphertext handle<br />
                      Submit Onchain Transaction to GhostVault.sol<br />
                      &nbsp;&nbsp;↓ Blockchain Block Confirmation on Sepolia<br />
                      GhostVault updates encrypted balance mappings<br />
                      &nbsp;&nbsp;↓<br />
                      Vault UI reflects updated position & enters draw pool
                    </div>

                    <p className="text-xs text-zinc-600 leading-relaxed">
                      Plaintext numbers exist strictly in your local browser memory prior to submission. 
                      Once submitted, the smart contract receives only the encrypted handle and zero-knowledge validity proof.
                    </p>
                  </div>
                )}
              ...
              <div className="space-y-8">
                {activeSubPageId === 'privacy-model' && (
                  <div className="space-y-6">
                    ...
                    <div className="p-5 rounded-2xl bg-zinc-900 text-white space-y-2 text-xs">
                      <div className="font-bold text-amber-400 uppercase tracking-wider text-[11px]">
                ...
                {activeSubPageId === 'what-is-public' && (
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-2xl font-bold tracking-tight text-zinc-950">
                        What Is Public
                      ...
                      <p className="text-xs text-zinc-500 mt-1">
                        Understanding what blockchain observers and indexers still see.
                      </p>
                    </div>

                    <div className="space-y-3 text-xs text-zinc-600 leading-relaxed">
                      <p>
                        We never claim "everything is private." Blockchain observers on Sepolia still observe:
                      </p>
                      <ul className="list-disc pl-5 space-y-1.5 font-mono text-[11px] text-zinc-700">
                        <li>Wallet Addresses submitting transactions</li>
                        <li>Smart contract method invocations (<code>deposit</code>, <code>withdraw</code>, <code>mint</code>)</li>
                        <li>Gas consumption and transaction timestamps</li>
                        <li>Public verification data (State roots and randomness commitments)</li>
                      </ul>
                    </div>
                  </div>
                )}
                ...
                {activeSubPageId === 'proof-of-privacy' && (
                  <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3 text-xs text-zinc-700">
                ...
                {activeSubPageId === 'protocol-overview' && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-1">
                        Hierarchical mapping of smart contract and FHE execution layers.
                      </p>
                    </div>

                    <div className="p-4 rounded-2xl bg-zinc-900 text-zinc-300 font-mono text-xs leading-relaxed overflow-x-auto">
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GHOST PROTOCOL<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┌───────────────┴───────────────┐<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;User Interface Layer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Smart Contract Layer<br />
                      &nbsp;&nbsp;&nbsp;(Vault / Web3 Client)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(GhostVault / GhostPool)<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└───────────────┬───────────────┘<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Zama fhEVM Engine<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┌───────────────┴───────────────┐<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;Encrypted euint64 State&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FHE Coprocessor Compute<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└───────────────┬───────────────┘<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;│<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Public Verification Proofs<br />
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(GhostVerifier / State Roots)
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3 text-xs text-zinc-600 font-mono">
                      <div className="p-3.5 bg-zinc-50 border border-zinc-200 rounded-xl">
                        ...
                        <div className="text-[11px] text-zinc-500 mt-1 font-sans">Stores the encrypted deposit principal for each participant wallet.</div>
                      </div>
                      <div className="p-3.5 bg-zinc-50 border border-zinc-200 rounded-xl">
                        <div className="font-bold text-zinc-900">euint64 private _totalPooledPrincipal;</div>
                        <div className="text-[11px] text-zinc-500 mt-1 font-sans">Homomorphic sum of all active deposits in the GhostVault.</div>
                      </div>
                      <div className="p-3.5 bg-zinc-50 border border-zinc-200 rounded-xl">
                        <div className="font-bold text-zinc-900">euint64 private _currentPrizePool;</div>
                        <div className="text-[11px] text-zinc-500 mt-1 font-sans">Encrypted yield pool accumulator earmarked for the next prize event.</div>
                      </div>
                    </div>
                  </div>
                )}

                {activeSubPageId === 'event-lifecycle' && (
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-2xl font-bold tracking-tight text-zinc-950">
                ...
                {activeSubPageId === 'system-architecture' && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-xs text-zinc-500 mt-1">
                        Separation of smart contracts, FHE coprocessors, Gateway, and KMS.
                      </p>
                    </div>

                    <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-3 text-xs text-zinc-600 leading-relaxed">
                      <p>
                        Ghost leverages Zama's decoupled coprocessor architecture. Heavy cryptographic polynomial evaluations are handled off-chain 
                        by the Torus FHE Coprocessor network, while EVM state updates and proof commitments are finalized on Ethereum Sepolia.
                      </p>
                    </div>
                  </div>
                )}
                    ...
                    <div className="space-y-3 text-xs">
                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-1">
                        <div className="font-bold text-zinc-900 flex items-center justify-between">
                          <span>GhostVault.sol</span>
                          <span className="font-mono text-[10px] text-zinc-400">0xA83889...8b96</span>
                        </div>
                        <p className="text-zinc-600">Non-custodial vault holding encrypted principal deposits and enforcing zero-loss guarantees.</p>
                      </div>

                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-1">
                        <div className="font-bold text-zinc-900 flex items-center justify-between">
                          <span>GhostPool.sol</span>
                          <span className="font-mono text-[10px] text-zinc-400">0x96e594...0b06</span>
                        </div>
                        <p className="text-zinc-600">Homomorphic yield pooling engine and savings rate compounding calculator.</p>
                      </div>

                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-1">
                        <div className="font-bold text-zinc-900 flex items-center justify-between">
                          <span>GhostDraw.sol</span>
                          <span className="font-mono text-[10px] text-zinc-400">0xFFDA13...957F</span>
                        </div>
                        <p className="text-zinc-600">Verifiable FHE randomness evaluator and prize dispatcher.</p>
                      </div>

                      <div className="p-4 rounded-2xl bg-zinc-50 border border-zinc-200 space-y-1">
                        <div className="font-bold text-zinc-900 flex items-center justify-between">
                          <span>MockConfidentialToken.sol (cUSDC)</span>
                          <span className="font-mono text-[10px] text-zinc-400">0x65C902...8B03</span>
                        </div>
                        <p className="text-zinc-600">Confidential ERC-20 test token supporting encrypted mints and balance transfers.</p>
                      </div>
                    </div>
                  </div>
                )}

                {activeSubPageId === 'backend-architecture' && (
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-2xl font-bold tracking-tight text-zinc-950">
                        Backend & Indexer Principles
                      </h2>
                      <p className="text-xs text-zinc-500 mt-1">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 text-xs">
                      <div className="space-y-1.5">
                        ...
                        <div className="p-3 bg-zinc-900 text-zinc-200 rounded-xl font-mono text-[11px] relative">
                          <code>
                          ...
                          <button
                            ...
                            className="absolute right-3 top-3 p-1 rounded bg-zinc-800 text-zinc-400 hover:text-white cursor-pointer"
                          >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="p-3 bg-zinc-900 text-zinc-200 rounded-xl font-mono text-[11px]">
